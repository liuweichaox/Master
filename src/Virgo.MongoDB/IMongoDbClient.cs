...
namespace Virgo.MongoDB
{
    public class MongoDbClientQ
    {
        ...
        private MongoDbClientQ(string url, string database)
        {
            Client = new MongoClient(url);
            Database = Client.GetDatabase(database);
        }

        private MongoDbClientQ(MongoClientSettings settings, string database)
        {
