            ...
            try
            {
                ...
                foreach (ManagementObject objMgmt in objCS.Get())
                {
                    ...
                    if (null != device)
                    {
                        ...
                        if (null != total)
                        {
                            dic.Add(device.ToString(), FormatBytes(double.Parse(total.ToString()) - double.Parse(free.ToString())));
                        }
                    }
                }
            ...
            try
            {
                ...
                foreach (ManagementObject objMgmt in objCS.Get())
                {
                    ...
                    if (null != device)
                    {
                        var free = objMgmt["FreeSpace"];
                        var total = objMgmt["Size"];
                        if (null != total && double.Parse(total.ToString()) > 0)
                        {
                            dic.Add(device.ToString(), 1 - double.Parse(free.ToString()) / double.Parse(total.ToString()));
                        }
                    }
                }
